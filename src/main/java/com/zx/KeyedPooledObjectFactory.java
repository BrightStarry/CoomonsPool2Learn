...
/**
 * 定义生命周期方法的接口，以供{@link org.apache.commons.pool2.KeyedObjectPool}实例使用
 * <p>
 * 当一个{@link org.apache.commons.pool2.KeyedObjectPool}委托给一个{@link KeyedPooledObjectFactory},
 * <ol>
 *  <li>
 ...
 * an {@link org.apache.commons.pool2.KeyedObjectPool} makes is that the same instance of an object will
 * not be passed to more than one method of a
 * <code>KeyedPoolableObjectFactory</code> at a time.
 * <p>
 * While clients of a {@link org.apache.commons.pool2.KeyedObjectPool} borrow and return instances of
